...
internal sealed class LessThanOrEqualSpecification<T> : ISpecification<T>
    where T : class
{
    ...
    public LessThanOrEqualSpecification(Type valueType, object value, string propertyName)
    {
    ...
    public Expression<Func<T, bool>> ToExpression()
    {
        ...
        var equal = Expression.LessThanOrEqual(nestedBody, valueConstant);
