...
internal sealed class GreaterThanSpecification<T> : ISpecification<T>
    where T : class
{
    ...
    public GreaterThanSpecification(Type valueType, object value, string propertyName)
    {
    ...
    public Expression<Func<T, bool>> ToExpression()
    {
        ...
        var equal = Expression.GreaterThan(nestedBody, valueConstant);
