...
internal sealed class LessThanSpecification<T> : ISpecification<T>
    where T : class
{
    ...
    public LessThanSpecification(Type valueType, object value, string propertyName)
    {
    ...
    public Expression<Func<T, bool>> ToExpression()
    {
        ...
        var equal = Expression.LessThan(nestedBody, valueConstant);
